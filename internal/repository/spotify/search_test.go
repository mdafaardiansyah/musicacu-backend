...
// Test_outbound_Search tests the functionality of the outbound Search method.
// It validates both successful and failed search cases by mocking the HTTP client.
// The test checks if the Search method returns the expected SpotifySearchResponse
// or an error based on the provided query, limit, and offset parameters.
